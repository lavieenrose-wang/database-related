...
CREATE OR REPLACE DIRECTORY data_file_dir AS '/u01/app/oracle/sample_schemas/sales_history/'; 
CREATE OR REPLACE DIRECTORY log_file_dir  AS '/u01/app/oracle/sample_schemas/log/'; 
CREATE OR REPLACE DIRECTORY media_dir     AS '/u01/app/oracle/sample_schemas/product_media/';
